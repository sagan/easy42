...
export const SyncProgressModal: React.FC<SyncProgressModalProps> = ({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 2.5 }}>
        ...
        {loadingPreview ? (
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            {/* Status Summary */}
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#F8FAFC', p: 1.5, borderRadius: 2, border: '1px solid #E2E8F0' }}>
              <Box>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flex: 1 }}>
                          ...
                          {act.diff_status === 'delete' || act.type === 'delete_config' ? (
                            <Chip
                              label="DELETE"
                              size="small"
                              sx={{ fontSize: '0.65rem', fontWeight: 700, height: 20, bgcolor: '#FEE2E2', color: '#DC2626', mr: 1 }}
                            />
                          ) : act.diff_status === 'update' ? (
                            <Chip
                              label="UPDATE"
                              size="small"
                              sx={{ fontSize: '0.65rem', fontWeight: 700, height: 20, bgcolor: '#FEF3C7', color: '#D97706', mr: 1 }}
                            />
                          ) : (
                            <Chip
                              label="CREATE"
                              size="small"
                              sx={{ fontSize: '0.65rem', fontWeight: 700, height: 20, bgcolor: '#E0E7FF', color: '#4338CA', mr: 1 }}
                            />
                          )}
                        </Box>
                      </AccordionSummary>
                ...
                <AccordionSummary expandIcon={<ChevronDown size={18} color="#64748B" />}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flex: 1 }}>
                    ...
                    <Chip
                      label="UP TO DATE"
                      size="small"
                      sx={{ fontSize: '0.65rem', fontWeight: 700, height: 20, bgcolor: '#ECFDF5', color: '#059669', ml: 'auto', mr: 1 }}
                    />
                  </Box>
                </AccordionSummary>
                <AccordionDetails sx={{ pt: 0 }}>
                    ...
                    {syncedActions.map((act, i) => (
                      ...
                      >
                        <Box>
                          ...
                          <Typography variant="caption" className="mono-font" sx={{ color: '#94A3B8', fontSize: '0.68rem' }}>
                        ...
                        <Chip
                          label="SYNCED"
                          size="small"
                          sx={{ fontSize: '0.65rem', fontWeight: 600, height: 18, bgcolor: '#F1F5F9', color: '#64748B' }}
                        />
                      </Box>
                    ))}
                  </Box>
      ...
      <DialogActions sx={{ px: 3, py: 2, borderTop: '1px solid #E2E8F0', backgroundColor: '#F8FAFC', justifyContent: 'space-between' }}>
